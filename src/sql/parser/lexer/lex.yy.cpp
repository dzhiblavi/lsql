...
{
  static const char *REGEX_INITIAL = "(?m)((?:[\\x09\\x0a\\x20]+))|((?:\\Q--\\E).*)|(SELECT)|(FROM)|(AS)|(WHERE)|(LIMIT)|(AND)|(OR)|(LIKE)|(MATERIALIZE)|(String)|(Int)|(Float)|(Bool)|(COUNT)|(true)|(false)|(null)|(ASC)|(DESC)|(MIN)|(MAX)|(SUM)|(IN)|(PERCENTILE)|(COALESCE)|(RSUBSTR)|((?:\\QGROUP BY\\E))|((?:\\QORDER BY\\E))|((?:\\QUNION ALL\\E))|((?:\\QUNION ALL SORTED BY\\E))|((?:[0-9]+))|((?:[\\x2b\\x2d]?[0-9]+\\.[0-9]+))|((?:[A-Z_a-z][0-9A-Z_a-z]*))|((?:[/\\x5c]?(?:[\\x2d.0-9A-Z_a-z]+[/\\x5c]+)*[\\x2d.0-9A-Z_a-z]+))|((?:'[^']*'))|((?:[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}))|((?:\\Q;\\E))|((?:\\Q,\\E))|((?:\\Q*\\E))|((?:\\Q=\\E))|((?:\\Q!=\\E))|((?:\\Q(\\E))|((?:\\Q)\\E))|((?:\\Q!\\E))|((?:\\Q+\\E))|((?:\\Q/\\E))|((?:\\Q@\\E))|((?:\\Q$\\E))|(.)";
...
#line 173 "sql_lexer.l"
{
            ...
            YY_BREAK
          case 32: // rule sql_lexer.l:178: "UNION ALL SORTED BY" :
            YY_USER_ACTION
#line 178 "sql_lexer.l"
{
                     lsql::sql::parse::Token t = {TOKEN_UNION_ALL_SORTED_BY, strdup(yytext), (int)strlen(yytext)};
                     Parse(g_parser, TOKEN_UNION_ALL_SORTED_BY, t, g_parse_context);
                 }

            YY_BREAK
          case 33: // rule sql_lexer.l:183: {INTEGER} :
            YY_USER_ACTION
#line 183 "sql_lexer.l"
{
            ...
            YY_BREAK
          case 34: // rule sql_lexer.l:188: {FLOATING} :
            YY_USER_ACTION
#line 188 "sql_lexer.l"
{
            ...
            YY_BREAK
          case 35: // rule sql_lexer.l:193: {IDENTIFIER} :
            YY_USER_ACTION
#line 193 "sql_lexer.l"
{
            ...
            YY_BREAK
          case 36: // rule sql_lexer.l:198: {PATH} :
            YY_USER_ACTION
#line 198 "sql_lexer.l"
{
            ...
            YY_BREAK
          case 37: // rule sql_lexer.l:203: {QUOTED_STRING} :
            YY_USER_ACTION
#line 203 "sql_lexer.l"
{
            ...
            YY_BREAK
          case 38: // rule sql_lexer.l:208: {TIMESTAMP} :
            YY_USER_ACTION
...
#line 268 "sql_lexer.l"
{
            ...
            YY_BREAK
          case 51: // rule sql_lexer.l:279: . :
            YY_USER_ACTION
#line 279 "sql_lexer.l"
{
