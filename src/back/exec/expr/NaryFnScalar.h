...
template <func::NaryExecutor E>
class NaryFnScalar : public Scalar {
 public:
    NaryFnScalar(ValueType value_type, E executor, std::vector<Arc<Scalar>> args)
